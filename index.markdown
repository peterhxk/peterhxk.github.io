...
- [**Word2Stock**](https://github.com/peterhxk/Word2Stocks) (On Going Project):
  Working with a group of classmates to develop a **AWS cloud-native** pipeline for **data processing** news and social media data with **NLP techniques** to assess sentiment and bias towards companies.
